...
def build_theorem_skeleton_obligations_545(
    *,
    ...
    return [
        ...
        TheoremSkeletonObligationRecord(
            signature="5-4-5",
            obligation_id="TS545-022",
            title="Candidate-level target discovery",
            statement="Stop assuming level 220 and test plausible comparison levels generated from bad-prime exponent variants.",
            current_evidence="The candidate-level layer generates 2^0..3 * 5^0..2 * 11^0..1, writes a Sage expander, and ranks levels by trace pressure and conductor plausibility.",
            status="level_data_insufficient",
            risk_level="high",
            next_action="Run the candidate-level Sage expander, import coefficient data, and compare whether trace pressure persists without the unjustified factor 11.",
        ),
        TheoremSkeletonObligationRecord(
            signature="5-4-5",
